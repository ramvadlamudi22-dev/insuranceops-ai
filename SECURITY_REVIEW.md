...
2. For each row, recompute `expected_current_hash = sha256(audit_event_id || workflow_run_id || actor || event_type || canonical_json(event_payload) || occurred_at_iso || coalesce(prev_event_hash, b''))`.
