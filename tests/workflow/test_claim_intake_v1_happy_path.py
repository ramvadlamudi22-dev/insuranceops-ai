...
from insuranceops.workflows.orchestrator import WorkflowOrchestrator
from insuranceops.workflows.steps.base import StepResult
from insuranceops.workflows.validators.base import ReferenceData, ValidationOutcome
...
class TestClaimIntakeV1HappyPath:
    ...
    def test_full_workflow_happy_path(self, sample_document_bytes: bytes) -> None:
        ...
        extraction_result = extractor.extract(
            sample_document_bytes, "text/plain", {}
        )
        ...
        validation_outcome = validator.validate(
            extraction_result, ReferenceData()
        )
        ...
        step_result = StepResult(
            ...
            output={
                "extraction": {
                    k: v.value for k, v in extraction_result.fields.items()
                },
    ...
    def test_extractor_and_validator_integration(
        self, sample_document_bytes: bytes
    ) -> None:
